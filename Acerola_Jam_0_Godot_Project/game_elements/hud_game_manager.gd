	...
	match game_state:
		0: #Game Tutorial Sequence
			...
			match dialog_state:
				...
				1:  #Sequential State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						Character_Dialog_Pane.display_text_sequential("Your job is to send good donuts to the packager, and bad donuts to the incinerator",0.05)
						dialog_timer_waiting = true
				...
				3:  #Sequential State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						Character_Dialog_Pane.display_text_sequential("Here, I'll ask the cooks to send you one good donut and one moldy donut as an example,",0.05)
				...
				4:  #Tutorial Fail State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						Character_Dialog_Pane.display_text_sequential("Uhh, let's try that again... put the moldy donut in the incinerator and the good donut in the packager,",0.05)
						Character_Dialog_Pane.change_inspector_face(2) #frown
				...
				5:  #Tutorial Succeed State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						...
						Character_Dialog_Pane.change_inspector_face(0) #happy
						dialog_timer_waiting = true
		...
		1: #Game Wave 1 ((24 total)  21 normal donuts, 3 bad donuts) 
			...
			match dialog_state:
				0: #GAME WAVE1 State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						Character_Dialog_Pane.display_text_sequential("I'll have you work on sorting your first batch of donuts",0.05)
					...
					if (player_path == enum_player_path.UNDEF) and ((Despawned_Items_Record["GoodDepot"]["DEFECT"] > 0) or (Despawned_Items_Record["Incinerator"]["REFINED"] > 0)) and (dialog_timer_waiting == true):
						...
						Character_Dialog_Pane.change_inspector_face(1) #slight suprise
					...
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						match player_path:
							...
							enum_player_path.BURN:
								...
								Character_Dialog_Pane.change_inspector_face(3) #Odd Grin
			...
			match dialog_state:
				0: #Sequential State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						...
						Character_Dialog_Pane.change_inspector_face(1) #Slight Surprise
						dialog_timer_waiting = true
					if dialog_timer > 8.0 and dialog_timer_waiting == true:
						dialog_timer_waiting = false
						dialog_timer = 0.0
				...
				1: #GAME WAVE2 State
					...
					if (player_path == enum_player_path.BURN) and (wave_2_burn_dialog == 0) and (Despawned_Items_Record["Incinerator"]["REFINED"]+Despawned_Items_Record["Incinerator"]["DEFECT"] > 15) and (dialog_timer_waiting == true):
						...
						Character_Dialog_Pane.change_inspector_face(3) #Slight Surprise
						...
						Character_Dialog_Pane.change_inspector_face(4) #Enjoying Fire
					...
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						match player_path:
							...
							enum_player_path.BURN:
								...
								Character_Dialog_Pane.change_inspector_face(5) #Enjoying Fire Too Much
							enum_player_path.PERFECT:
			...
			match dialog_state:
				...
				1: #GAME WAVE2 State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						...
						match player_path:
							...
							enum_player_path.PERFECT:
								...
								Character_Dialog_Pane.change_inspector_face(0) #Smile
					...
					if (player_path == enum_player_path.BURN) and (wave_3_burn_dialog == 0) and (Despawned_Items_Record["Incinerator"]["DEMON"] > 6) and (dialog_timer_waiting == true):
						...
						Character_Dialog_Pane.change_inspector_face(8) #Less Happy about Fire
						wave_3_burn_dialog = -1
						...
						match player_path:
							...
							enum_player_path.BURN:
								if wave_3_burn_dialog == -2:
									...
									Character_Dialog_Pane.change_inspector_face(7) #DRAINED
									...
									Character_Dialog_Pane.change_inspector_face(6) #DEMONIC
							enum_player_path.PERFECT:
			...
			match dialog_state:
				0: #Sequential State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						...
						Character_Dialog_Pane.change_inspector_face(0) #Slight Surprise
						dialog_timer_waiting = true
					if dialog_timer > 5.0 and dialog_timer_waiting == true:
						dialog_timer_waiting = false
						dialog_timer = 0.0
				...
				2: #Sequential State
					if dialog_timer > 0.1 and dialog_timer_waiting == false:
						...
						Character_Dialog_Pane.change_inspector_face(9) #Slight Surprise
